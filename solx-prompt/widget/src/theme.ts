...
/* The one cue that distinguishes "still working" from "stuck" - a progress
   strip that never moves reads as a hang. Honoured only where motion is
   wanted. */
@keyframes solx-pulse { 0%, 100% { opacity: 1; } 50% { opacity: 0.55; } }
.chip.pulse { animation: solx-pulse 1.4s ease-in-out infinite; }
